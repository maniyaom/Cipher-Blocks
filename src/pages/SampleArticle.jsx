      ...
      <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
        <div className="flex justify-between px-4 mx-auto max-w-screen-xl text-white">
          <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <header className="mb-4 lg:mb-6 not-format">
              <address className="flex items-center mb-6 not-italic">
                <div className="inline-flex items-center mr-3 text-sm text-white dark:text-white">
                  ...
                  <div>
                    <span className="text-xl font-bold text-white dark:text-white">Jese Leos</span>
                    <p className="text-base text-white dark:text-white">Author</p>
              ...
              <h1 className="mb-4 text-3xl font-extrabold leading-tight text-white lg:mb-6 lg:text-4xl dark:text-white">Best practices for successful prototypes</h1>
            </header>
            <p className="text-white mb-4">Flowbite is an open-source library of UI components built with the utility-first
              classNamees from Tailwind CSS. It also includes interactive elements such as dropdowns, modals,
              datepickers.</p>
            <p className='mb-4'>Before going digital, you might benefit from scribbling down some ideas in a sketchbook. This way,
              you can think things through before committing to an actual design project.</p>
            <p className='mb-4'>But then I found a component library. It comes with the most commonly used UI components, such as buttons, navigation
            ...
            <h2 className='text-2xl font-bold mb-2.5'>Getting started with Flowbite</h2>
            <p className='mb-4'>First of all you need to understand how Flowbite works. This library is not another framework.
              Rather, it is a set of components based on Tailwind CSS that you can just copy-paste from the
              documentation.</p>
            <p className='mb-4'>It also includes a JavaScript file that enables interactive components, such as modals, dropdowns,
              and datepickers which you can optionally include into your project via CDN or NPM.</p>
            <p className='mb-4'>You can check out the quick to explore the elements by including the CDN files into your project. But if you want
            ...
            <p className='mb-4'>You'll also receive a lot of useful application UI, marketing UI, and e-commerce pages that can help
            ...
            <h2 className='text-2xl font-bold mb-2.5'>When does design come in handy?</h2>
            <p className='mb-4'>While it might seem like extra work at a first glance, here are some key moments in which prototyping
              will come in handy:</p>
            <ol className='list-decimal list-inside'>
              <li className='mb-3'><strong>Usability testing</strong>. Does your user know how to exit out of screens? Can they
              ...
              <li className='mb-3'><strong>Involving stakeholders</strong>. Need to check if your GDPR consent boxes are displaying
                properly? Pass your prototype to your data protection team and they can test it for real;</li>
              <li className='mb-3'><strong>Impressing a client</strong>. Prototypes can help explain or even sell your idea by
                providing your client with a hands-on experience;</li>
              <li className='mb-3'><strong>Communicating your vision</strong>. By using an interactive medium to preview and test
                design elements, designers and developers can understand each other — and the project — better.
              </li>
            </ol>
            <h3 className='text-xl font-bold mb-2.5'>Laying the groundwork for best design</h3>
            <p className='mb-4'>Before going digital, you might benefit from scribbling down some ideas in a sketchbook. This way,
              you can think things through before committing to an actual design project.</p>
            <p className='mb-4'>Let's start by including the CSS file inside the <code>head</code> tag of your HTML.</p>
            <h3 className='text-xl font-bold mb-2.5'>Understanding typography</h3>
            <h4 className='text-base font-semibold mb-2.5'>Type properties</h4>
            <p className='mb-4'>A typeface is a collection of letters. While each letter is unique, certain shapes are shared across
              letters. A typeface represents shared patterns across a collection of letters.</p>
            <h4 className='text-base font-semibold mb-2.5'>Baseline</h4>
            <p className='mb-4'>A typeface is a collection of letters. While each letter is unique, certain shapes are shared across
              letters. A typeface represents shared patterns across a collection of letters.</p>
            <h4 className='text-base font-semibold mb-2.5'>Measurement from the baseline</h4>
            <p className='mb-4'>A typeface is a collection of letters. While each letter is unique, certain shapes are shared across
              letters. A typeface represents shared patterns across a collection of letters.</p>
            <h3 className='text-xl font-bold mb-2.5'>Type classNameification</h3>
            <h4 className='text-base font-semibold mb-2.5'>Serif</h4>
            <p className='mb-4'>A serif is a small shape or projection that appears at the beginning or end of a stroke on a letter.
              Typefaces with serifs are called serif typefaces. Serif fonts are classNameified as one of the
              following:</p>
            <h4 className='text-base font-semibold mb-2.5'>Old-Style serifs</h4>
            ...
            <h3 className='text-xl font-bold mb-2.5'>Laying the best for successful prototyping</h3>
            <p className='mb-4'>A serif is a small shape or projection that appears at the beginning:</p>
            <section className="not-format">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-lg lg:text-2xl font-bold text-white dark:text-white">Discussion (1)</h2>
              </div>
              <form className="mb-6">
                <div className="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                  <label htmlFor="comment" className="sr-only">Your comment</label>
                  <textarea id="comment" rows="6"
                    className="px-0 w-full text-sm text-white border-0 outline-none focus:ring-0 dark:text-white dark:placeholder-gray-400 dark:bg-gray-800"
              ...
              <article className="p-6 mb-6 text-base bg-white rounded-lg dark:bg-gray-900">
                <footer className="flex justify-between items-center mb-2">
                  <div className="flex items-center">
                    <p className="inline-flex items-center mr-3 font-semibold text-sm text-white dark:text-white"><img
                      className="mr-2 w-6 h-6 rounded-full"
                      src={profile_image}
                      alt="Michael Gough" />Michael Gough</p>
                    <p className="text-sm text-white dark:text-white"><time pubdate dateTime="2022-02-08"
      ...
      <footer className="bg-gray-50 dark:bg-gray-800 antialiased">
        <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
          ...
          <div className="text-center">
            <a href="#" className="flex justify-center items-center mb-5 text-2xl font-semibold text-white dark:text-white">
            ...
            <span className="block text-sm text-center text-white dark:text-white">© 2021-2022 <a href="#" className="hover:underline">Flowbite™</a>. All Rights Reserved.
            </span>
            <ul className="flex justify-center mt-5 space-x-5">
              <li>
                <a href="#" className="text-white hover:text-white dark:hover:text-white dark:text-white">
